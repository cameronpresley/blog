...
To help Lean TECHniques with their Microsoft partnership, I spent time over the summer working on obtaining various Microsoft certifications (I ran out of time before getting the _Microsoft Certified: Azure Solutions Architect Expert_ certificate, but that's on my docket for 2025)

- Earned the [Microsoft Certified: Azure Administrator Associate](https://learn.microsoft.com/en-us/users/cameronpresley-4042/credentials/2cb0f6ef15460e5c) certification
- Earned the [Microsoft Certified: Azure Developer Associate](https://learn.microsoft.com/en-us/users/cameronpresley-4042/credentials/ec65dd88cb49f4a2) certification
- Earned the [Microsoft Certified: DevOps Engineer Expert](https://learn.microsoft.com/en-us/users/
cameronpresley-4042/credentials/aabf4a1a96bb75e6) certification

Last, but not least, I spent some time learning some (new to me tech) like GraphQL and basic Java.

- Earned the [Graph Developer - Associate certification](https://www.apollographql.com/tutorials/certifications/a77be40c-1085-45c8-895f-464d2dcf4cd6) from Apollo GraphQL
- Was included as an acknowledgement in _[Pragmatic Unit Testing in Java with JUnit: 3rd Edition by Jeff Langr](https://pragprog.com/titles/utj3/pragmatic-unit-testing-in-java-with-junit-third-edition/)_ for my feedback and review before publishing.

## Community

On the community side, 2024 was a year of firsts. For example, I hosted and organized [Queen City Code Camp](https://www.eventbookings.com/b/event/queen-city-code-retreat), a conference where attendees learned the fundamentals of Test Driven Development (TDD) by solving the Mars Rover kata. This was the first time since 2019 that I organized a conference (and absolutely the first time since I moved to North Carolina), so lots of good lessons learned here.

In another first, I created my first training video, [Navigating Mars Using Functional Programming in TypeScript](https://www.udemy.com/course/navigating-mars-using-ts-and-fp/?referralCode=134CA0E5EF78A43698B3), a Udemy course where I walk you through how to solve the Mars Rover kata using functional programming concepts.
...
- Volunteered with [Cub Scout Pack 58](https://www.cubpack58.org/)
...
My last major goal for 2025 is to build a [hope chest](https://en.wikipedia.org/wiki/Hope_chest) as this is a solid piece of fine furniture and it can be something I can pass down to my children when it comes time.
