...
- Source Control: [GitHub](https://github.com/cameronpresley/lte-mars-rover)
- Language/Framework: C# on [.NET Core 3.1](https://dotnet.microsoft.com/download)
- Unit Testing Framework: [NUnit](https://nunit.org/)
- Mocking Framework: [NSubstitute](https://nsubstitute.github.io/)
- Editor: [Visual Studio Code](https://code.visualstudio.com/)

### Series

- [Part 0 – Introduction](./mars-rover-intro.md)
- [Part 1 – Defining the Problem](./mars-rover-definition.md)
- [Part 2 – Modeling Concepts](./mars-rover-modeling.md)
- [Part 3 – Intro to Testing](./mars-rover-testing.md)
- [Part 4 – Creating a Rover](./mars-rover-creating.md)
- [Part 5 – Rover Moving Forward](./mars-rover-forward.md)
- [Part 6 – Rover Moving Backward](./mars-rover-backward.md)
- [Part 7 – Rover Turning Left](./mars-rover-left.md)
- [Part 8 – Refactoring Rover](./mars-rover-refactoring.md)
- [Part 9 – Rover Turning Right](./mars-rover-right.md)
- [Part 10 – Creating a Logger](./mars-rover-create-logger.md)
