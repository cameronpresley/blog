...
My approach is to keep the team focused so we can get through it, but to also have a [retrospective](https://en.wikipedia.org/wiki/Retrospective#Software_development) on what happened and what we could do to prevent another slog from happening again.
