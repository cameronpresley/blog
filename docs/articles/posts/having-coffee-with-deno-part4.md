...
![Listing of Secrets](https://softwarementorblog.blob.core.windows.net/images/deno-actions/secret-configuration.png)
...
<figure markdown>
![Superman and Batman having coffee](https://softwarementorblog.blob.core.windows.net/images/deno-actions/batman-superman-coffee.png)
